				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>WHAT DOES ${bean.companyName}
									DO WITH YOUR PERSONAL INFORMATION?</p></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>Financial companies choose
									...
									carefully to understand what we do.</p></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>The types of personal
									information we collect and share depend on the product or
									service you have with us. This information can include:</p>
								<ul>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>All financial companies need
									...
									reasons ${bean.companyName} chooses to share; and whether you
									can limit this sharing.</p></td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<div class="content-section">
			<div class="content-row">
				<table>
					...
					<tbody>
						<tr>
							<td><b>For our everyday business purpose - </b>such as to
		...
		<div class="content-section">
								...
								<ul>
									<c:choose>
										<c:when test="${bean.optPhone != '-1'}">
											<li>Call ${bean.optPhone} - our menu will prompt you
												through your choice(s) or</li>
										</c:when>
										<c:when test="${bean.optWebsite != '-1'}">
											<li>Visit us online: <a href="${bean.optWebsite}">
													${bean.optWebsite} </a></li>
										</c:when>
										<c:when test="${bean.city != '-1'}">
											<li>Mail the form below</li>
										</c:when>
										<c:when test="${bean.thirdPartyCookie != '-1'}">
											<li>Visit <a href="${bean.thirdPartyCookie}">${bean.thirdPartyCookie}</a>
												to opt-out by cookie
											</li>
										</c:when>
			...
			<li>Visit <a href="${bean.dntoptout}">${bean.dntoptout}</a> to opt-out by
				Do-Not-Track plugin
								...
								<p>If you are a new customer, we can begin sharing your
									information ${bean.numOfDays} days from the date we sent this
									notice. When you are no longer our customer, we continue to
									share your information as described in this notice.</p>
								<p>However, you can contact us at any time to limit our
									sharing.</p>
							</td>
						</tr>
					</tbody>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><c:choose>
									<c:when test="${bean.phoneText != '-1'}">
        	Call ${bean.phoneText}
        	<c:choose>
											<c:when
												test="${bean.websiteText != '-1' && bean.websiteText != ''}">
        	or go to <a href="${bean.websiteText}">${bean.websiteText}
												</a>
											</c:when>
										</c:choose>
									</c:when>
		...
		<div class="content-section">
			...
			<div class="content-row">
				<table>
					<tbody>
						<tr>
							<td class="cpn-heading-white">How does ${bean.companyName}
								protect my personal information?</td>
							<td class="cpn-details"><p>To protect your personal
									information from unauthorized access and use, we use security
									measures that comply with federal law. These measures include
									computer safeguards and secured files and buildings.</p>
								<p>${bean.howProtect }</p></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="content-row">
				<table>
					<tbody>
						<tr>
							<td class="cpn-heading-white">How does ${bean.companyName}
								collect my personal information?</td>
							<td class="cpn-details"><p>We collect your personal
									information, for example, when you</p>
								<ul>
         ...
         We also collect your personal information from others, such as credit bureaus, affiliates, or other companies.
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>Federal law gives you the
									right to limit only</p>
								<ul>
			...
			<div class="content-row">
				<table>
					<tbody>
						<tr>
							<td class="cpn-heading-white">What happens when I limit
								sharing for an account I hold jointly with someone else?</td>
							<td class="cpn-details"><c:choose>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>Companies related by common
									ownership or control. They can be financial and nonfinancial
									companies.</p>
								<ul>
									<c:choose>
										<c:when
											test="${bean.affiliate == '-1' && bean.noneaffiliate == '-1' && bean.others == '-1' }">
											<li>${bean.companyName}doesnot share with affiliates</li>
										</c:when>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>Companies not related by
								...
								<ul>
									...
									<c:choose>
										...
										<c:otherwise>
											<li>${bean.companyName}doesnot share with nonaffiliate
												so they can market to you</li>
										</c:otherwise>
									</c:choose>
				...
				<table>
					<tbody>
						<tr>
							...
							<td class="cpn-details"><p>A formal agreement between
									nonaffiliated financial companies that together market
								...
								<ul>
									<c:choose>
										...
										<c:otherwise>
											<li>${bean.companyName}doesnot jointly market</li>
										</c:otherwise>
									</c:choose>
								</ul></td>
						</tr>
						...
						<table>
							<tr>
								...
								<td class="mailin-details"><p class="padding-5px">Mark
									...
									<p class="padding-5px">[ ] Do not share information about
										my creditworthiness with your affiliates for their everyday
										business purposes.</p>
									...
									<table>
										<tr>
											...
											<td class="mail-addr-mailto" rowspan="5">
												...
												<p>
													${bean.companyName }<br /> ${ bean.address}<br />${bean.city }
													${bean.state } ${bean.zipcode }
												</p>
											</td>
										</tr>
										<tr>
