  ...
  <div> 
   ...
   <div class="content-section"> 
    <div class="content-row">
     <p></p>
     <p style="text-align:right">Rev. undefined</p>
     <p></p>
    </div> 
   </div> 
   <div class="content-section"> 
     ...
     <table> 
      <tbody>
       <tr> 
        ...
        <td class="cpn-details"><p>WHAT DOES undefined DO WITH YOUR PERSONAL INFORMATION?</p></td> 
       </tr> 
      </tbody>
     </table> 
    </div> 
     ...
     <table>
      <tbody>
       <tr>
        ...
        <td class="cpn-details"><p>All financial companies need to share customers' personal information to run their everyday business. In the section below, we list the reasons financial companies can share their customers' personal information; the reasons undefined chooses to share; and whether you can limit this sharing.</p></td>
       </tr>
      </tbody>
     </table>
    </div>
     ...
     <table>
      ...
      <tbody>
       <tr>
        ...
        <td class="centered-td">Undef</td>
        <td class="centered-td">We don't share</td>
       </tr>
      </tbody>
      <tbody>
       <tr>
      ...
      <tbody>
       <tr>
        ...
        <td class="cpn-details">
         <ul></ul><p><b>Please note:</b></p><p>If you are a new customer, we can begin sharing your information 0 days from the date we sent this notice. When you are no longer our customer, we continue to share your information as described in this notice.</p><p>However, you can contact us at any time to limit our sharing.</p></td>
       </tr>
      </tbody>
     </table>
    </div>
   ...
   <div class="content-section">
    ...
    <div class="content-row">
     <table>
      <tbody>
       <tr>
        <td class="cpn-heading-white">How does undefined protect my personal information?</td>
        <td class="cpn-details"><p>To protect your personal information from unauthorized access and use, we use security measures that comply with federal law. These measures include computer safeguards and secured files and buildings.</p><p>undefined</p></td>
       </tr>
      </tbody>
     </table>
    </div>
    <div class="content-row">
     <table>
      <tbody>
       <tr>
        <td class="cpn-heading-white">How does undefined collect my personal information?</td>
     ...
     <table>
      <tbody>
       <tr>
        ...
        <td class="cpn-details"><p>Your choices will apply individually - unless you tell us otherwise.</p></td>
       </tr>
      </tbody>
     </table>
    </div>
      ...
      <tbody>
       <tr>
        ...
        <td class="cpn-details"><p>Companies related by common ownership or control. They can be financial and nonfinancial companies.</p>
         <ul>
          <li>undefined has no affiliates.</li>
         </ul></td>
       </tr>
      </tbody>
     </table>
      ...
      <tbody>
       <tr>
        ...
        <td class="cpn-details"><p>Companies not related by common ownership or control. They can be financial and nonfinancial companies.</p>
         <ul>
          <li>undefined does not share with nonaffiliates so they can market to you</li>
         </ul></td>
       </tr>
      </tbody>
     </table>
      ...
      <tbody>
       <tr>
        ...
        <td class="cpn-details"><p>A formal agreement between nonaffiliated financial companies that together market financial products or services to you.</p>
         <ul>
          <li>undefined doesn't jointly market.</li>
         </ul></td>
       </tr>
      </tbody>
     </table>
