			...
			<form role="form" method="post" name="testForm">
				<div class="form-group">
					<label for="companyName">1. Enter the name of your
						...
						name="companyName" id="companyName" value="${bean.companyName }" />
				...
				<div class="form-group">
					<label for="reviseDate">2. Enter last revised date
						(mm/yyyy): *</label> <input type="text" class="form-control"
						name="reviseDate" id="reviseDate" placeholder="Example: 05/2015"
						value="${bean.reviseDate }" />
				...
				<div class="form-group">
					<label for="companyName">3. What types of personal
						information you collect and share? * (Choose exactly 5 options)</label>
				...
				<div class="form-group">
					<label for="">4. Please select "Yes" if any of the
						following statement is true: *</label>
					<div id="error-affiliatemarkettocus" style="display: none">
						<h5 style="color: red;">You must select Yes or No.</h5>
					</div>
					<ul>
						<li>Your organization does not have affiliates (or doesn't
							disclose personal information to its affiliates)</li>
					...
					<div class="radio">
						<label> <input type="radio" name="affiliatemarkettocus"
							id="affiliatemarkettocus" value="no"
							onclick="showQ5intable(this)"> No
						</label>
					</div>
				</div>
				<script>
				...
				<div class="form-group">
					<label for="reviseDate">5. Does your organization provide
						opt-out service? *</label>
					<div id="error-opt-outSuper" style="display: none">
						<h5 style="color: red;">You must select Yes or No.</h5>
					</div>
					<div class="radio">
						<label> <input type="radio" name="isoptout" id="isoptout"
							value="yes" onclick="showMethod(this)"> Yes
						</label>
					</div>
					<div class="radio">
				...
				<div class="form-group" id="optmethod" style="display: none">
					<label for="opt-out">6. What opt-out methods will you
						offer? (At least one) *</label>
					...
					<table style="width: 100%">
						<tr>
							<td width="15%"><input type="checkbox" name="opt_out"
								value="1" onclick="showPhone(this)"> Phone</td>
							<td width="15%"><input type="checkbox" name="opt_out"
								value="2" onclick="showWebsite(this)"> Website</td>
							<td width="15%"><input type="checkbox" name="opt_out"
								value="3" onclick="showMail(this)"> Mail-in</td>
							<td width="15%"><input type="checkbox" name="opt_out"
								value="2" onclick="show3Party(this)"> Third Party Cookie
								Optout <span
								title="The opt-out cookie tells the website not to install third party advertiser or other cookies on your browser.&#10;They can only block cookies from a specific server and won't block cookies from other websites"
								class="glyphicon glyphicon-question-sign"></span></td>
							<td width="15%"><input type="checkbox" name="opt_out"
								value="2" onclick="showDNTPlugin(this)"> Do-Not-Track
								Plugin <span
								title="DNT+ is a free-of-charge browser add-on, trying to many companies from tracking users across the Internet."
								class="glyphicon glyphicon-question-sign"></span></td>
				...
				<div class="content-row">
					<label>7. Please select Yes/No or we do not share depending
						if the reason on the left column to share personal information is
						valid to your organization.*</label>
						...
						<tbody>
							<tr>
								<td><strong>Does your organization share
										information for everyday business purposes? </strong> &mdash; Such as
									to process transactions, maintain customers account(s), respond
							...
							<tr>
								...
								<td class="centered-td"><select name="question1b"
									id="question1b" readonly="false">
										...
										<option value="No" id="noShare1">We do not share</option>
								</select></td>
							</tr>
							<tr>
								<td><strong> Does your organization share
							...
							<tr>
								<td><strong>Does your organization share
										information for affiliates&rsquo; &rsquo;everyday business
										purposes? </strong>&mdash; Information such as creditworthiness</td>
							...
							<tr id="Q5" style="display: none;">
								...
								<td class="centered-td"><select id="question5"
									name="question5" onchange="changeQ5()">
				...
				<div class="content-row" id="phoneArea" style="display: none">
					<div class="content-row">
						...
						<div id="errorPhone" style="display: none">
							<h5 style="color: red;">You must fill in the phone number
								for opt-out</h5>
						</div>
						<input type="text" class="form-control"
							placeholder="Phone number for opt-out" id="phonephone"
							name="optPhone" value="${bean.optPhone}">
					</div>
				</div>
				<br />
				...
				<div class="content-row" id="websiteArea" style="display: none">
					<div class="content-row">
						...
						<div id="errorWebsite" style="display: none">
							<h5 style="color: red;">You must fill in the website for
								opt-out</h5>
						</div>
						<input type="text" class="form-control"
							placeholder="Website for opt-out" id="optWebsite"
							name="optWebsite" value="${bean.optWebsite}">
					</div>
					<br />
				</div>
				<br />
					...
					<div class="content-row" id="mailinForm">
						...
						<div id="optionalInfo" class="leftpad" style="display: none">
							...
							<input type="radio" name="optionsRadios" id="radio1"
								...
								type="radio" name="optionsRadios" id="radio1"
								value="Truncated Account Number"> Truncated Account
							Number<br />
						</div>
						<br />
						...
						<table style="width: 100%">
							<tr>
								...
								<td>&nbsp;&nbsp;<input name="address" type="text"
									id="Address" value="${bean.address}"></td>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;<input type="text" name="zipcode"
									id="zipcode" value="${bean.zipcode}"></td>
							</tr>
						</table>
					</div>
				</div>
				...
				<div class="content-row" id="thirdPartyArea" style="display: none">
					<div class="content-row">
						...
						<div id="error3party" style="display: none">
							<h5 style="color: red;">You must fill in the the link for
								opt-out</h5>
						</div>
						<input type="text" class="form-control"
							placeholder="Link for opt-out" id="thirdPartyCookie"
							name="thirdPartyCookie" value="${bean.thirdPartyCookie}">
					</div>
					<br />
				</div>
				<br />
				...
				<div class="content-row" id="dntplugin" style="display: none">
					<div class="content-row">
						...
						<input type="text" class="form-control"
							placeholder="Link for opt-out" id="dntoptout" name="dntoptout">
					</div>
					<br />
				</div>
				<br />
				...
				<div class="content-row" id="begindate" style="display: none">
					<label>8. How many days can you begin sharing new
						customer's information from the date you sent the notice to the
						customer? *</label> <br />
					<div id="error-begindate" style="display: none">
						<h5 style="color: red;">Please fill in the days that is no
							less than 30</h5>
					</div>
					<input type="text" class="form-control" id="numberOfDays"
						placeholder="No less than 30 days" name="numOfDays"
						value="${bean.numOfDays }">
				</div>
				<br />

				<div class="form-group">
					<label for="servicecontact">9. What customer service
						contact information will you provide (select at least one method)?
						*</label>
					<div id="error-opt-contactMethod" style="display: none">
						<h5 style="color: red;">Please select at least one contact
							method</h5>
					</div>
					<div id="error-opt-contactMethod2" style="display: none">
						<h5 style="color: red;">Please fill in the contact
							information</h5>
					</div>
					<table style="width: 100%">
						<tr>
							...
							<td><input type="text" class="form-control"
								placeholder="Phone Number" id="phoneText" name="phoneText"
								value="${bean.phoneText }"></td>
						</tr>
						<tr>
							...
							<td><input type="text" class="form-control"
								...
								name="websiteText" value="${bean.websiteText }"></td>
						</tr>
					</table>
				</div>

				<div class="form-group">
					<label for="twoOrMoreInstitute">10. Please list the
						financial institutions that <strong>jointly</strong> provide this
						privacy policy.
					</label>
					<c:choose>
						<c:when test="${bean.whoseNotice != '-1'}">
							<textarea class="form-control" rows="3" name="whoseNotice"
								id="InsititueNotice"
								placeholder="You can ommit this area if you are the only institution providing this notice; otherwise, jointly parties should be identified clearly.">${bean.whoseNotice }</textarea>
						</c:when>
						<c:otherwise>
							<textarea class="form-control" rows="3" name="whoseNotice"
								id="InsititueNotice"
				...
				<div class="form-group">
					<label for="howProtect">11. How do you protect user's
						personal information? *</label>
					<div id="error-protect" style="display: none">
						<h5 style="color: red;">Please type in your ways of
							protecting user's personal information</h5>
					</div>
					<c:choose>
						<c:when test="${bean.howProtect != '-1'}">
							<textarea id="protectWay" class="form-control" rows="3"
								name="howProtect"
								placeholder="The safeguards practices may include information about the institution’s use of cookies or other measures it uses to 206 safeguard personal information. No more than 30 additional words">${bean.howProtect }</textarea>
						</c:when>
						<c:otherwise>
							<textarea id="protectWay" class="form-control" rows="3"
								name="howProtect"
				...
				<div class="form-group">
					<label for="collect">12. How do you collect user's personal
						information? *(Choose exactly 5 options)</label>
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Pay Insurance premiums"> Pay Insurance premiums
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
					...
					<div class="checkbox">
						<label> <input type="checkbox" vname="collect"
							alue="Seek advice about your investments"> Seek advice
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Sell securities to us or direct us to buy/sell securities">
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Enter into an investment advisory contract"> Enter
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Apply for financing"> Apply for financing
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Apply for lease"> Apply for lease
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
					...
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Provide your mortgage information"> Provide your
							mortgage information
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Make a wire transfer"> Make a wire transfer
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Make a wire transfer"> Tell us who receives the
							money
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Tell us where to send the money"> Tell us where to
							send the money
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Show us your government issued ID"> Show us your
							government issued ID
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Show your driver's license"> Show your driver's
							license
						</label>
					</div>
					<div class="checkbox">
						<label> <input type="checkbox" name="collect"
							value="Order commodity futures or option trade"> Order
					...
					<div class="form-group">
						<label for="collectaffiliate">13. Do you collect
							information from affiliates and/or credit bureaus?<span
							title="It's a company that collects information from various sources and provides consumer credit information on individual consumers for a variety of uses."
						...
						<div class="radio">
							<label> <input type="radio" name="collectaffiliate"
								id="collectaffiliate" value="no"> No
							</label>
						</div>
					</div>

					<script>
						$("input[name='collectaffiliate']").change(function() {
					...
					<div class="form-group" style="display: none" id="isFromCompany">
						<label for="isFromAff">14. Do you collect information from
						...
						<div class="radio">
							<label> <input type="radio" name="isFromCompany"
								id="isFromCompany" value="yes"> Yes
							</label>
						</div>
						<div class="radio">
							<label> <input type="radio" name="isFromCompany"
								id="isFromCompany" value="no"> No
							</label>
						</div>
					</div>

					<div class="form-group">
						<label for="isPresentLaw">15. Would you like to refer to
							state privacy law provisions? (If choose yes, you should provide
							law details) *</label>
						<div class="radio">
						...
						<div class="radio">
							<label> <input type="radio" name="isPresentLaw"
								id="isPresentLaw" value="no" onclick="disappearLawArea(this)">
								No
							</label>
						</div>
						...
						<div class="content-row" id="lawarea" style="display: none">
							<label for="isPresentLaw">Please provide law details
								here:</label>
							<div class="radio">
								<label> <c:choose>
										<c:when test="${bean.lawDetails != '-1'}">
											<textarea class="form-control" rows="3" name="lawDetails">${bean.lawDetails }</textarea>
										</c:when>
										<c:otherwise>
						...
						<div class="form-group" id="applyscope" style="display: none">
							<label for="why">16. What happens when users limit
								sharing for an account that is jointly held with someone else?</label>
							<div class="radio">
								<label> <input type="radio" name="whatHappenWhenLimit"
									value="1" checked> Your choices apply to everyone on
									the account
								</label>
							</div>
							<div class="radio">
								<label> <input type="radio" name="whatHappenWhenLimit"
									value="2"> Your choices will apply to everyone on the
						...
						<div class="form-group" id="affiliateProgram"
							style="display: block">
							<label for="">17. Please list your affiliates you share
								with below? *</label> <br /> <label for="">Financial Companies:</label>
							<c:choose>
								<c:when test="${bean.affiliate != '-1'}">
									<textarea class="form-control" rows="3" name="affiliate">${bean.affiliate}</textarea>
								</c:when>
								<c:otherwise>
							...
							<c:choose>
								<c:when test="${bean.noneaffiliate != '-1'}">
									<textarea class="form-control" rows="3" name="noneaffiliate">${bean.noneaffiliate }</textarea>
								</c:when>
								<c:otherwise>
							...
							<c:choose>
								<c:when test="${bean.others != '-1'}">
									<textarea class="form-control" rows="3" name="others">${bean.others }</textarea>
								</c:when>
								<c:otherwise>
						...
						<div class="form-group" id="noneAffiliateProgram">
							<label for="noneAffiliateProgram">18. Please list your
								non-affiliates below?</label>

							<c:choose>
								<c:when test="${bean.noneAffiliateProgram != '-1'}">
									<textarea class="form-control" rows="3"
										name="noneAffiliateProgram" id="noneAffiliateProgram"
										placeholder="Categories of companies, such as mortgage companies, insurance companies, direct marketing companies, and nonprofit organizations">${bean.noneAffiliateProgram }</textarea>
								</c:when>
								<c:otherwise>
									<textarea class="form-control" rows="3"
										name="noneAffiliateProgram" id="noneAffiliateProgram"
						...
						<div class="form-group" id="jointMarketing">
							<label for="">19. Please list your joint marketing
								partners below?</label>
							<c:choose>
								<c:when test="${bean.jointMarketing != '-1'}">
									<textarea class="form-control" rows="3" name="jointMarketing"
										placeholder="list categories of companies, such as credit card companies">${bean.jointMarketing }</textarea>
								</c:when>
								<c:otherwise>
									<textarea class="form-control" rows="3" name="jointMarketing"
										placeholder="list categories of companies, such as credit card companies"></textarea>
								</c:otherwise>
							</c:choose>
						</div>

						<div class="form-group">
							<label for="stateLaw">20. Please provide other
								information information.</label>
							<c:choose>
								<c:when test="${bean.stateLaw != '-1'}">
									<textarea name="stateLaw" class="form-control" rows="7"
										placeholder="Example: acknowledgment of receipt form.">${bean.stateLaw }</textarea>
								</c:when>
								<c:otherwise>
									<textarea name="stateLaw" class="form-control" rows="7"
