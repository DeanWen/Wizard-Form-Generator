...
public class QuestionairForm extends FormBean{
	...
	public QuestionairForm() {
		...
		this.isAffiliateProgram = "-1";
		this.shareAffiliateProgram = "-1";
		this.affiliateProgram = "-1";
		this.shareNoneAffiliateProgram = "-1";
		this.noneAffiliateProgram = "-1";
		this.isJointMarketing = "-1";
	...
	public String getTwoOrMoreInstitute() {
	...
	public String getIsAffiliateProgram() {
		return isAffiliateProgram;
	}
	public void setIsAffiliateProgram(String isAffiliateProgram) {
		this.isAffiliateProgram = isAffiliateProgram;
	}
	public String getShareAffiliateProgram() {
	...
	public String getShareNoneAffiliateProgram() {
	...
	public String getIsJointMarketing() {
		return isJointMarketing;
	}
	public void setIsJointMarketing(String isJointMarketing) {
